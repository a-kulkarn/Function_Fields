...
\STATE   $g\longleftarrow g_1$
\STATE   $t,r\longleftarrow \mathrm{PPIO}(g_2,g)$
\STATE   $ 1,u,v\longleftarrow \mathrm{xgcd}(g^2,t)$
\STATE   $\gamma \longleftarrow v\cdot t\cdot \gamma_1+u\cdot g^2  $
\STATE    $\textbf{return } $(g,\gamma)$
