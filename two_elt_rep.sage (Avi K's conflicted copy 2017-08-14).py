...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_5 = Integer(5); _sage_const_11 = Integer(11)
...
Zx = PolynomialRing(ZZ, names=('x',)); (x,) = Zx._first_ngens(1)

Zx = PolynomialRing(ZZ, names=('x',)); (x,) = Zx._first_ngens(1)
p = _sage_const_5 

P = decompose_prime(K,p)[_sage_const_0 ]

p = _sage_const_7 

Q = decompose_prime(K,p)[_sage_const_0 ]
...
W = dedekind_ideal(P,_sage_const_1 ,false,None)

WW = dedekind_ideal(Q,_sage_const_5 ,false,None)
